/*Text To Link*/
if (typeof(Text_To_Link) === 'undefined') {
	var Text_To_Link = true;
	let position = document.querySelector('head');
...
/*Pure Mobile Baidu*/
if (typeof(Pure_Mobile_Baidu) === 'undefined') {
	var Pure_Mobile_Baidu = true;
	let position = document.querySelector('head');
	let newTag = document.createElement("script");
